...
- [Deriving state via computed signals](#deriving-state-via-computed-signals)
- [Managing global app state](#managing-global-app-state)
- [Local state with signals](#local-state-with-signals)
- [Advanced signals usage](#advanced-signals-usage)
- [API](#api)
